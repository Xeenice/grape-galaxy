...
<div id="eula" style="display: none">
	<div class="eula">
		<h2>ЛИЦЕНЗИОННОЕ СОГЛАШЕНИЕ С КОНЕЧНЫМ ПОЛЬЗОВАТЕЛЕМ</h2>

		<p>Настоящее лицензионное соглашение является документом,
			...
			имеет права использовать Программу.</p>

		<p>Программа используется сторонами настоящего Лицензионного
			...
			сохраняются за Правообладателем.</p>

		<p>Данная лицензия предоставляет Игроку право бесплатного
			...
			информационно-развлекательных услуг.</p>

		<p>Игроку запрещается вскрывать технологию и декомпилировать
		...
		<p>В наибольшей степени, допускаемой действующим
			...
			осуществлялся выход в Интернет.</p>

		<h2>ИСПОЛЬЗУЕМОЕ СТОРОННЕЕ ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ</h2>

		<p>WebGL implementation of O3D is used under the BSD 2-Clause
			License. Copyright (c) 2009, Google Inc.</p>

		<p>OGRE is used under the MIT License. Copyright (c) 2000-2009
			Torus Knot Software Ltd. See www.ogre3d.org for details.</p>

		<p>FreeType is used by OGRE under the FreeType Project License.
			Copyright (c) 2009 The FreeType Project. See www.freetype.org for
			details.</p>

		<p>FreeImage is used by OGRE under the FIPL, version 1.0. See
			http://freeimage.sourceforge.net for details.</p>

		<p>FreeImage is based in part on the work of the G. Lane
			Independent JPEG Group. See http://www.ijg.org for details.</p>

		<p>FreeImage is based in part on the work of the Gerard Juyn,
			Glenn Randers-Pehrson, Raphael Assenat, John Stiles. See
			http://www.libmng.com for details.</p>

		<p>FreeImage is based in part on the work of the Guy Eric
			Schalnat, Andreas Dilger, Glenn Randers-Pehrson and others. See
			http://www.libpng.org for details.</p>

		<p>FreeImage is based in part on the work of the Sam Leffler,
			Silicon Graphics Inc. See http://www.libtiff.org/ for details.</p>

		<p>Open Dynamics Engine is used under the BSD-style License.
			Copyright (c) 2001-2007, Russell L. Smith.</p>
	</div>
</div>
